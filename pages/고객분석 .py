...
st.write("""
##### ✔ 상위 10위 유저별 최대 평점 수 
- USER-00656이 1242번으로 가장 많은 평점을 달았으며 독서량이 가장 많은 것을 알 수 있다.
- 그 뒤로 USER-00550, 00699,00214 등이 많은 평점을 달았다는 것을 알 수 있다.
""")
import streamlit as st
import pandas as pd
import matplotlib.pyplot as plt
...
sns.barplot(x='N_ratings', y='User-ID', data=df_user,palette='Set3')
